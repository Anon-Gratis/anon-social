...
enum class PachliFlavor(
    ...
    val appName: String = "Anon Social",
    val customLogoUrl: String = "",
    val customInstance: String = "social.anonymous.gratis",
    val supportAccountUrl: String = "https://social.anonymous.gratis/@anongratis",
    val supportEmail: String = "admin@anon.gratis",
) {
    blue(FlavorDimension.color),
    orange(
        FlavorDimension.color,
        applicationIdSuffix = ".current",
        appName = "Anon Social Current",
    ),
